...
> **Extends:** ssi_school_character_activity — model `school_character_activity`, aksi `01-create`
...
- The Character Learning Activity list/form is filtered by an `ir.rule` for users in the
