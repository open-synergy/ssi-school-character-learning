...
============================================
Character Learning Activity - Operating Unit
============================================

Operating Unit support for the SSI Character Learning Activity module.
Adds operating unit access control to the transactional model
school_character_activity, restricting each character learning activity
