...
- **Data:** At least one **Character Construct** (`school_character_construct`)
  exists.
...
4. Optionally fill in **Subconstruct**, **Academic Year**, **Academic Term**,
   **Provisional Level**.
5. On the **Evidence Entries** tab, add one or more evidence lines, each
   recording a **Date**, **Activity**, **Arena**, **Indicator**, **Observer**,
   **Observed Behavior**, **Source Type**, and **Evidence Quality**.
6. Click **Save**.
