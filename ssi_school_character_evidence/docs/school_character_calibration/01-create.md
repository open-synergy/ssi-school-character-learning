...
4. On the **Scope** tab, select the **Constructs**, **Participants**, and **Anchors**
   covered by this calibration session.
5. On the **Ratings** tab, add one or more rating lines, each linking a **Participant**,
   an **Anchor**, and the **Assigned Level** that participant scored it at.
6. Click **Save**.
