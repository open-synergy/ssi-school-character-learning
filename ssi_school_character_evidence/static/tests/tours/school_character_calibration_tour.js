odoo.define("ssi_school_character_evidence.school_character_calibration_tour", function (
    require
) {
    "use strict";
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            ...
            },
            {
                ...
                trigger:
                    ".o_field_many2many_tags[name='construct_ids'] input",
            ...
            },
            {
                ...
                trigger:
                    ".o_field_many2many_tags[name='participant_ids'] input",
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            ...
            {content: "Wizard is open", trigger: ".o_form_view", run: function () {}},
            {
                ...
                run: "text TOUR Calibration Cancel Reason",
            },
            {
                content: "Pick the reason",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(TOUR Calibration Cancel Reason)",
                in_modal: false,
            },
            {
