odoo.define("ssi_school_character_curriculum.school_character_curriculum_tour", function (
    require
) {
    "use strict";
    ...
    function openMenuSteps() {
        return [
            ...
            {
                content: "Open the Curriculum menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_school_character_curriculum.menu_character_curriculum_root"]',
            },
            {
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            ...
            {content: "Wizard is open", trigger: ".o_form_view", run: function () {}},
            {
                ...
                run: "text TOUR Curriculum Cancel Reason",
            },
            {
                content: "Pick the reason",
                trigger:
                    ".ui-autocomplete .ui-menu-item a:contains(TOUR Curriculum Cancel Reason)",
                in_modal: false,
            },
            {
