...
odoo.define(
    "ssi_school_character_evidence_operating_unit.school_character_calibration_tour",
    function (require) {
        "use strict";

        var tour = require("web_tour.tour");

        // IK: docs/school_character_calibration/01-create.md (E1 delta --
        // Additional Fields). Navigation (open menu -> New) is taken from
        // the base IK ssi_school_character_evidence/docs/
        // school_character_calibration/01-create.md Flow steps 1-2. The
        ...
        tour.register(
            "ssi_school_character_evidence_operating_unit_calibration_create",
            {
                test: true,
                url: "/web",
            },
