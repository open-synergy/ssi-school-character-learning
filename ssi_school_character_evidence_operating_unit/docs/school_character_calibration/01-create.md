...
> **Extends:** ssi_school_character_evidence — model `school_character_calibration`,
> aksi `01-create`
...
- The Character Teacher Calibration list/form is filtered by an `ir.rule` for users
  in the *Operating Unit* group: they can only read/write/create/unlink documents
