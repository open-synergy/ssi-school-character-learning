...
> **Extends:** ssi_school_character_evidence — model `school_character_observation`,
> aksi `01-create`
...
- **Operating Unit**: The operating unit this Character Observation document
...
- The Character Observation list/form is filtered by an `ir.rule` for users in the
  *Operating Unit* group: they can only read/write/create/unlink documents whose
