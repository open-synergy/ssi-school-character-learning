...
> **Module:** ssi_school_character_curriculum_operating_unit\
> **Extends:** ssi_school_character_curriculum — model `school_character_curriculum`, aksi
> `01-create`
...
- **Operating Unit**: The operating unit this Character Curriculum Map document belongs
...
- The Character Curriculum Map list/form is filtered by an `ir.rule` for users in the
