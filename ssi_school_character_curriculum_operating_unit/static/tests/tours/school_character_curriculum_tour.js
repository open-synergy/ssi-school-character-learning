...
odoo.define(
    "ssi_school_character_curriculum_operating_unit.school_character_curriculum_tour",
    function (require) {
        "use strict";

        var tour = require("web_tour.tour");

        // IK: docs/school_character_curriculum/01-create.md (E1 delta --
        // Additional Fields). Navigation (open menu -> New) is taken from
        // the base IK ssi_school_character_curriculum/docs/
        // school_character_curriculum/01-create.md Flow steps 1-2 -- see
        ...
        tour.register(
            "ssi_school_character_curriculum_operating_unit_curriculum_create",
            {
                test: true,
                url: "/web",
            },
            [
                ...
                // Curriculum > Character Curriculum Maps menu. "Curriculum"
