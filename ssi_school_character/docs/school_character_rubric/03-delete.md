...
- **Record:** The record exists and is not referenced by any other document.
...
- The record no longer exists. Its descriptor lines are deleted along with it.
