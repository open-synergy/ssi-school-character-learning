odoo.define("ssi_school_character.school_character_family_tour", function (require) {
    "use strict";
    ...
    function openMenuSteps() {
        return [
            ...
            {
                content: "Open the Character Families menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_school_character.school_character_family_menu"]',
            },
            {
    ...
    tour.register(
        "ssi_school_character_school_character_family_create",
        {test: true, url: "/web"},
        [
            ...openMenuSteps(),
            {
            ...
            },
            {
                ...
                run: "text Tour Family New",
            },
            {
                content: "Fill in Code",
                trigger: ".o_field_widget[name='code']",
                run: "text TOUR-NEW-FAMILY",
            },
            {
    ...
    tour.register(
        "ssi_school_character_school_character_family_edit",
        {test: true, url: "/web"},
        [
            ...openMenuSteps(),
            {
                content: "Open the record to edit",
                trigger: ".o_data_row:contains(Tour Family Edit)",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Click Edit",
    ...
    tour.register(
        "ssi_school_character_school_character_family_delete",
        {test: true, url: "/web"},
        [
            ...openMenuSteps(),
            {
                content: "Open the record to delete",
                trigger: ".o_data_row:contains(Tour Family Delete)",
                extra_trigger: ".o_list_view",
            },
            {
    ...
    tour.register(
        ...
        [
            ...openMenuSteps(),
            {
                ...
                trigger:
                    ".o_data_row:contains(Tour Family Deactivate) .o_list_record_selector input",
            },
            {
                content: "Open the Action menu",
                trigger: ".o_cp_action_menus button:contains(Action)",
            ...
            },
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(Tour Family Deactivate)))",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                    return true;
                },
    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                trigger:
                    ".o_data_row:contains(Tour Family Activate) .o_list_record_selector input",
            },
            {
                content: "Open the Action menu",
                trigger: ".o_cp_action_menus button:contains(Action)",
            ...
            },
            {
                ...
                trigger: ".o_data_row:contains(Tour Family Activate)",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                    return true;
                },
