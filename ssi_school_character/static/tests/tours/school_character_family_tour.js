    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                run: "text Tour Character Familie New",
            },
            {
    ...
    tour.register(
        ...
        [
            ...openMenuSteps(),
            {
                ...
                trigger: ".o_data_row:contains(Tour Character Familie Edit)",
                extra_trigger: ".o_list_view",
            },
            {
                content: "Click Edit",
    ...
    tour.register(
        ...
        [
            ...openMenuSteps(),
            {
                ...
                trigger: ".o_data_row:contains(Tour Character Familie Delete)",
                extra_trigger: ".o_list_view",
            },
            {
    ...
    tour.register(
        ...
        [
            ...openMenuSteps(),
            {
                ...
                trigger:
                    ".o_data_row:contains(Tour Character Familie Deactivate) .o_list_record_selector input",
            },
            {
                content: "Open the Action menu",
                trigger: ".o_cp_action_menus button:contains(Action)",
    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                trigger:
                    ".o_data_row:contains(Tour Character Familie Activate) .o_list_record_selector input",
            },
            {
                content: "Open the Action menu",
                trigger: ".o_cp_action_menus button:contains(Action)",
