...
4. Optionally fill in **Arena**, **Method**, **Curriculum Map**, **Grade Class**,
   **Teacher**, **Learning Objective (RBT)**, **RBT Level**, **DOK Level**, **SOLO
   Target**.
5. On the **Alignment** tab, add one or more alignment lines linking an **Indicator** to
   the activity's RBT/DOK/SOLO design.
6. Click **Save**.
