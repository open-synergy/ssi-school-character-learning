odoo.define("ssi_school_character_growth_report.school_character_growth_report_tour", function (
    require
) {
    "use strict";
        ...
        [].concat(openMenuSteps(), [
            {
                ...
                trigger: ".o_data_row:contains(TOUR Growth Student 02) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 03) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 04) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 05) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
            ...
            },
            {
                ...
                trigger: ".o_statusbar_status .o_arrow_button[data-value='open'].btn-primary",
                run: function () {},
            },
        ])
    );
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 06) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 09) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
            ...
            },
            {
                ...
                trigger: ".o_statusbar_status .o_arrow_button[data-value='done'].btn-primary",
                run: function () {},
            },
        ])
    );
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 10) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
            ...
            {content: "Wizard is open", trigger: ".o_form_view", run: function () {}},
            {
    ...
    tour.register(
        ...
        [].concat(openMenuSteps(), [
            {
                content: "Open the record",
                trigger: ".o_data_row:contains(TOUR Growth Student 12) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {trigger: ".o_form_view", run: function () {}},
            {
