...
4. Optionally fill in **Academic Year**, **Academic Term**, **Homeroom
   Teacher**, **Calibration**, **Pathway**.
5. On the **Growth Lines** tab, add one or more lines, each linking a
   **Construct** to its **Achieved Level**, **Growth Narrative**, **Next
   Step**, and supporting **Evidence Entries**.
